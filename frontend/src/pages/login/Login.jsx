    ...
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
      <div className="w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
        ...
        <form  onSubmit={handleSubmit}>
          ...
          <div>
            <button className="btn btn-block btn-sm mt-2 bg-black border-none hover:bg-black text-white" disabled={loading}>
...
//     <div>
//         <button className="btn btn-block btn-sm mt-2 bg-black border-none hover:bg-black text-white">Login</button>
//     </div>
